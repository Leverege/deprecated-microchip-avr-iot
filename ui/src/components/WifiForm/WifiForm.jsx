  ...
  render () {
    ...
    const pwSection = ( 
      <div className={ 'pw-group' }>
        <Input placeholder='Network Password' invalid={ error && error.field === 'pw' } required={true} value={ pw } onChange={ e => this.handlePwChange( e.target.value ) } type={ hidePw ? 'password' : 'text' } />
