...
export default class Overview extends React.Component {
  componentDidMount() {
    document.getElementById("deviceVideo").play()
  }
        ...
        <section className="overview-body">
          ...
          <div className="overview-content">
            <div className="overview-text">
              ...
              <p>Using the power of the <a href="https://start.atmel.com/" target="_blank" className="overview-link">AVR START</a> tool, a free, professional, <i>rapid development tool (code generator)</i>, you can now add Google Cloud connectivity to new and existing projects with a click of your mouse.</p>
            ...
            <div className="overview-video">
              <video id="deviceVideo" autoplay muted loop>
                <source src="https://storage.googleapis.com/avr-iot-media/microchip_device.mp4" type="video/mp4"/>
              </video>
            </div>
          </div> 
